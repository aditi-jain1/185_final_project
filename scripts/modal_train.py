...
def _rerank_eval_entrypoint(*args: str) -> None:
    normalized_args = _normalize_args(args)
    cmd = ["python", "-u", "-m", "llm_rl_final_proj.offline.rerank_eval", *normalized_args]
    _run_subprocess_with_periodic_volume_commits(cmd)
...
def rerank_eval_remote(*args: str) -> None:
    _rerank_eval_entrypoint(*args)
